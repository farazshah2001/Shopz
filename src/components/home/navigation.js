...
{loggedIn && <Link to="/sell"><li className="z-10  text-xl md:text-2xl lg:text-4xl mx-2 md:mx-8 border-2 border-blue-800 hover:border-white rounded-full px-2 md:py-2">Sell</li> </Link>}      
  ...
  <div class="container flex flex-wrap justify-between items-center mx-auto">
    <a href="" class="flex items-center">
        ...
        <span class="self-center text-xl font-semibold whitespace-nowrap text-white">Shopz</span>
    </a>
    ...
    <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
      <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
        <li>
            {page == "home" ? loggedIn && <Link to="/profile"><a href="#" class="block py-2 pr-4 pl-3 text-gray-200 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-white md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Profile</a></Link>:
                 <Link to="/"><a href="#" class="block py-2 pr-4 pl-3 text-gray-200 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-white md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Home</a></Link>
            }
        </li>
        <li>
           {loggedIn && <Link to="/sell"><a href="#" class="block py-2 pr-4 pl-3 text-gray-200 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-white md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Sell</a></Link>}
        </li>
        <li>
          <Link to="login"><a href="#" class="block py-2 pr-4 pl-3 text-gray-200 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-white md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">{loggedIn ? <p onClick={()=>{localStorage.setItem("loggedUser", "")}}>Logout</p> : <p>Login</p>}</a></Link>
        </li>
      </ul>
    </div>
  </div>
